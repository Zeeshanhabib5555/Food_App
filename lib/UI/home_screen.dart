  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Center(
          child: Text("Home Screen",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontStyle: FontStyle.italic),),
        ),
        actions: [Icon(Icons.notification_add_outlined,color: Colors.white,),
        SizedBox(width: 10,)
        ],
      ),
                      ...
                      "${menue[index].toString()}",
                          ...
                          InkWell(
                              ...
                              child: Image(
                                width: 200,
                                height: 100,
                                image: AssetImage(crashers[index % crashers.length].toString() ),)),
                          SizedBox(height: 10,),
                          Row(
                            //mainAxisAlignment: MainAxisAlignment.start,
                            crossAxisAlignment: CrossAxisAlignment.start,
